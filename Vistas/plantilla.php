	...
	<div class="barra">
		...
		<div class="container">
			...
			<?php if (isset($_GET["pagina"])): ?>
				...
				<?php if ($_GET["pagina"] == "registroNotas"): ?>
					<li class="nav-item">
						<a class="nav-link active" href="index.php?pagina=registrarNotas">Registrar Notas</a>
					</li>
					<?php else: ?>

					<li class="nav-item">
						<a class="nav-link" href="index.php?pagina=registrarNotas">Registrar Notas</a>
					</li>
				<?php endif ?>
